...
public protocol Layoutable {
    func layout(in proposedSize: CGSize) -> LayoutResult
}
...
extension ElementContent {
    public init(builder: @escaping (Environment) -> Element) {
        self.storage = BuildingStorage(
            layout: PassthroughLayout(),
            builder: ChildBuilderWrapper(builder: builder))
    }
}
